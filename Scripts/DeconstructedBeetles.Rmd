...
One last test, can the sum of the dimeter/2 of two adjacent particles explain its centre to centre distance? 
...
This is a short description of the procedure I used to extract the centre to centre distance and the diameter of the transversal section of the cylinders from the TEM images

Here I refer as "particle" to the circle correspondent to a transversal section of a cylinder in the structure. Cylinders are filled with air and surrounded by a matrix of chitin. 
...
We are comparing models in which the cylinders transversal section is a circle of diameter 700, 820 and 1000 nm in two polariations: incident light polarized parallel (continuous) and perpendicular (dashed) to the cylinder axis
...
The plot shows the probability of reflectance of light inciding perpendicular to the cylinder axis 
...
|Model|Shape|MaxAxis|MinAxis|Centre-Centre|Status|
|:-------:|:-------:|:-------:|:-------:|:-------:|:-------:|:-------:|
|A|Circles|700 nm|NA|Auto|Done|
|B|Circles|820 nm|NA|Auto|Done|
|C|Circles|1000 nm|NA|Auto|Done|
|1|Circles|500 nm|NA|Auto|Pending|
|2|Circles|700 nm|NA|710 nm| same as A?|
|3|Circles|700 nm|NA|900 nm|Pending|
|4|Ellipses|820 nm| 500 nm|850 nm|Pending|

* Particle size: Model A, B, C and 1 will explain broad band reflectance

* Particle Separation: Compare model 2 and 3 identify the contribution of the chitin matrix

* Particle shape: Compare model 4,1, and B to identify the contribution of the shape
